...
export const demoCases = [
  ...
  },
  {
    ...
    confidence: 0.49, requires_review: true,
    review_reasons: ['Catalog subject record was not identified unambiguously'],
    scenario_note: 'The unknown code is the only subject text. Leaving the catalog identity empty is the correct safe result, although a person still needs to review it.',
  },
  {
    ...
    scenario_note: 'The code is unknown, while the name matches a catalog entry. The name is shown as evidence; no canonical subject is assigned because the codes disagree.',
  },
  {
    ...
    review_reasons: ['Extracted subject code is absent from the catalog', 'No strong name candidate was found in the embedding index'],
    scenario_note: 'Both the code lookup and the global name search failed to identify a strong catalog candidate. This is an expected abstention, not a proven catalog omission.',
  },
  {
